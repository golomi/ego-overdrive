...
#ifndef DUKETEXTURECONTAINER_H
#define DUKETEXTURECONTAINER_H

#include <SDL2/SDL.h>

#include "DukeTexture.h"

#include "TextureContainerInterface.h"
...
class DukeTextureContainer : public TextureContainerInterface{
private:
...
public:
    ...
    DukeTextureContainer();
    virtual ~DukeTextureContainer();

    void loadCommon(SDL_Renderer* renderer);
    void loadDrops(SDL_Renderer* renderer, std::string mainDrop, std::string secondDrop);
    virtual SDL_Texture *getTexture(int n) override;
    void freeAll();

};

#endif /* DUKETEXTURECONTAINER_H */
